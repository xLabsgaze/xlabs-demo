...
bkcore.hexgl.HUD.prototype.update = function(speed, speedRatio, shield, shieldRatio, useXLabsController)
{
...
//                this.ctx.fillText('haha', SCREEN_HW, SCREEN_HEIGHT -200);
	...
	else if(this.step == 1)
	{
        ...
        //autoAcc
        if(xLabsController!=null)
        {
            if(xLabsController.autoAcc){

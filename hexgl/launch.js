...
(function() {
  ...
  s = [['controlType', ['KEYBOARD', 'XLABS' , 'TOUCH', 'LEAP MOTION CONTROLLER', 'GAMEPAD'], 1, 1, 'Controls: '], ['quality', ['LOW', 'MID', 'HIGH', 'VERY HIGH'], 1, 1, 'Quality: '], ['hud', ['OFF', 'ON'], 1, 1, 'HUD: '], ['godmode', ['OFF', 'ON'], 0, 1, 'Godmode: ']];

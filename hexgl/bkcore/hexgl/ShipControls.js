...
bkcore.hexgl.ShipControls = function(ctx)
{
    ...
    else if(ctx.controlType == 1) // && xLabsController.isReady)
    {
        this.useXLabsController = true;
    }
...
bkcore.hexgl.ShipControls.prototype.update = function(dt)
{
    ...
    if(this.active)
    {
        ...
        else if(this.useXLabsController){
            angularAmount += xLabsController.convertValue2( xLabsController.roll*4,
                                                            xLabsController.breakPointsX,
                                                            xLabsController.breakPointsY ) * this.angularSpeed * dt;
            rollAmount -= xLabsController.convertValue2( xLabsController.roll*3,
            	                                         xLabsController.breakPointsX,
            	                                         xLabsController.breakPointsY ) * this.rollAngle;
        }
        else
        {
            if(this.key.left)
        ...
        if(this.key.forward || (this.useXLabsController && xLabsController.autoAcc==true && !this.key.backward))
